defmodule CuzCoreConnectWeb.UserLive.Registration do
  ...
  def mount(_params, _session, socket) do
    changeset = Account.change_user_email(%User{}, %{}, validate_unique: false)
  ...
  def handle_event("save", %{"user" => user_params}, socket) do
    case Account.register_user(user_params) do
      {:ok, user} ->
        {:ok, _} =
          Account.deliver_login_instructions(
            user,
  ...
  def handle_event("validate", %{"user" => user_params}, socket) do
    changeset = Account.change_user_email(%User{}, user_params, validate_unique: false)
