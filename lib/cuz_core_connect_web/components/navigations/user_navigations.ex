defmodule CuzCoreConnectWeb.Navigations.User do
  ...
  def side_nav(assigns) do
    ...
    #     CuzCoreConnect.Pages.default_merchant_page_access()
    #   else
      ...
      <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-8 space-y-2 overflow-y-auto scrollbar-thin scrollbar-thumb-orange-500/20 scrollbar-track-transparent border-t border-orange-500/10">
          ...
          <.navigation_link
            ...
            active={@current_page == :student_registered}
            icon="academic-cap"
            label="Registered Students"
          />
          <.navigation_link
            href="/student/pending"
            active={@current_page == :student_pending}
            icon="clock"
            label="Pending Registrations"
          />
          <.navigation_link
            href="/student/courses"
            active={@current_page == :student_courses}
            icon="book-open"
