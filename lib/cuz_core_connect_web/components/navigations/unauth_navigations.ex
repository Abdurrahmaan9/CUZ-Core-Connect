        ...
        <div class="hidden md:flex items-center space-x-6">
          <ul class="flex items-center space-x-6">
            <li>
              <a
                href="/#about"
                class="font-medium rounded-sm px-1 py-0.5 hover:text-primary transition-colors duration-300"
              >
                About
              </a>
            </li>
    ...
    <!-- Mobile Menu -->
      <%= if @show_mobile_menu do %>
        <div class="md:hidden border-t border-base-200 bg-base-100/95 backdrop-blur-sm mt-4 -mx-4 px-4 py-4 rounded-b-xl">
          <nav class="space-y-4">
            <div class="space-y-2">
              <a href="/#about" class="block font-medium rounded-sm px-2 py-2 hover:bg-base-200">
                About
              </a>
              <a href="/#developers" class="block font-medium rounded-sm px-2 py-2 hover:bg-base-200">
                Developers
              </a>
              <a href="/#help-center" class="block font-medium rounded-sm px-2 py-2 hover:bg-base-200">
                Help Center
              </a>
            </div>
            <div class="border-t border-base-200 pt-4 space-y-2">
              ...
              <.link
                href={~p"/users/log-in"}
                class="block w-full btn btn-outline border-gray-300 hover:bg-base-300 text-center"
              >
                Log In
              </.link>
              <.link
